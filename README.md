...
* **Guardian AI:** I'm developing a platform that automatically reads and audits huge documents using language models and background task queues. 
...
* **Languages:** TypeScript, Python, Go, and SQL
* **Web Stuff:** Next.js (my go-to), React, Node.js, and FastAPI
